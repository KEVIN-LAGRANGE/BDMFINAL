# -*- coding: utf-8 -*-
"""Copy of Copy of Copy of BDM_Final_Sample.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1XhWMlC2rku0DN3q9P5ZI0DLNQHCjj_BM
"""
...
if __name__=='__main__':
  ...
  def mapper2(x):
    ...
    if x[0][1] == '2019-03':
      ...
      return (x[0][0],'','','',m) 
  print("l2", l2[:20])
  print('keys',sc.textFile('/tmp/bdm/weekly-patterns-nyc-2019-2020/*', use_unicode=True).mapPartitionsWithIndex(mapper1).take(20))
  
  # output1 = sc.textFile('weekly-patterns-nyc-2019-2020-sample.csv', use_unicode=True).mapPartitionsWithIndex(mapper1) \
